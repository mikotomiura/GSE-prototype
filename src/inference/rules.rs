...
pub fn classify_state(flight_time_ms: u64, backspace_count: u32) -> FlowState {
...
mod tests {
    ...
    #[test]
    fn test_stuck_state() {
        assert_eq!(classify_state(600, 0), FlowState::Stuck);
        assert_eq!(classify_state(100, 6), FlowState::Stuck);
        assert_eq!(classify_state(800, 3), FlowState::Stuck);
    }
}
